/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2bad9f2ed345d582b97e549ebcd0fab6)
// Runtime types generated with workerd@1.20250902.0 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OPENAI_API_KEY: string;
		Chat: DurableObjectNamespace<import("./src/server").Chat>;
		DroneAgent: DurableObjectNamespace<import("./src/server").DroneAgent>;
		AI: Ai;
	}
}
